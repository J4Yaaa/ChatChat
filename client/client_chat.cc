...
void* ShowOutput(void* arg)
{
    ...
    std::string online_info;   // 要加入在线表中的用户的信息
    int step = 1;
    int x,y;
    ...
    while(1)
    {
        ...
        msg += "-";
        msg += d.school;
        online_info = msg; // 这里在线列表只显示 昵称-学校
        msg += "> ";
        msg += d.msg;
...
int main(int argc,char* argv[])
{
    ...
    pthread_create(&input,NULL,ShowOutput,&nw);
    pthread_create(&output,NULL,ShowInput,&nw);
